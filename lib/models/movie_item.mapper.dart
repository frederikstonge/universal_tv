...
class MovieItemMapper extends ClassMapperBase<MovieItem> {
  ...
  static List<String> _$categoryIds(MovieItem v) => v.categoryIds;
  static const Field<MovieItem, List<String>> _f$categoryIds = Field(
    'categoryIds',
    _$categoryIds,
  );
...
mixin MovieItemMappable {
  String toJson() {
    return MovieItemMapper.ensureInitialized().encodeJson<MovieItem>(
      this as MovieItem,
    );
  }

  Map<String, dynamic> toMap() {
    return MovieItemMapper.ensureInitialized().encodeMap<MovieItem>(
      this as MovieItem,
    );
  }
  ...
  @override
  String toString() {
    return MovieItemMapper.ensureInitialized().stringifyValue(
      this as MovieItem,
    );
  }
  ...
  bool operator ==(Object other) {
    return MovieItemMapper.ensureInitialized().equalsValue(
      this as MovieItem,
      other,
    );
  }
