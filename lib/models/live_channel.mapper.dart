...
class LiveChannelMapper extends ClassMapperBase<LiveChannel> {
  ...
  static const Field<LiveChannel, String> _f$categoryId = Field(
    'categoryId',
    _$categoryId,
  );
  ...
  static const Field<LiveChannel, String> _f$epgChannelId = Field(
    'epgChannelId',
    _$epgChannelId,
    opt: true,
  );
...
mixin LiveChannelMappable {
  String toJson() {
    return LiveChannelMapper.ensureInitialized().encodeJson<LiveChannel>(
      this as LiveChannel,
    );
  }

  Map<String, dynamic> toMap() {
    return LiveChannelMapper.ensureInitialized().encodeMap<LiveChannel>(
      this as LiveChannel,
    );
  }
  ...
  @override
  String toString() {
    return LiveChannelMapper.ensureInitialized().stringifyValue(
      this as LiveChannel,
    );
  }
  ...
  bool operator ==(Object other) {
    return LiveChannelMapper.ensureInitialized().equalsValue(
      this as LiveChannel,
      other,
    );
  }
