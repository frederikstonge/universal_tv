...
class IptvEntryMapper extends ClassMapperBase<IptvEntry> {
  ...
  static const Field<IptvEntry, String> _f$logoUrl = Field(
    'logoUrl',
    _$logoUrl,
  );
  static List<String>? _$categories(IptvEntry v) => v.categories;
  static const Field<IptvEntry, List<String>> _f$categories = Field(
    'categories',
    _$categories,
  );
  ...
  static const Field<IptvEntry, String> _f$epgId = Field(
    'epgId',
    _$epgId,
    opt: true,
  );
...
mixin IptvEntryMappable {
  String toJson() {
    return IptvEntryMapper.ensureInitialized().encodeJson<IptvEntry>(
      this as IptvEntry,
    );
  }

  Map<String, dynamic> toMap() {
    return IptvEntryMapper.ensureInitialized().encodeMap<IptvEntry>(
      this as IptvEntry,
    );
  }
  ...
  @override
  String toString() {
    return IptvEntryMapper.ensureInitialized().stringifyValue(
      this as IptvEntry,
    );
  }
  ...
  bool operator ==(Object other) {
    return IptvEntryMapper.ensureInitialized().equalsValue(
      this as IptvEntry,
      other,
    );
  }
