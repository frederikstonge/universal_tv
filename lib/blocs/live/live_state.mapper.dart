...
class LiveStateMapper extends ClassMapperBase<LiveState> {
  ...
  static const Field<LiveState, List<Category>> _f$categories = Field(
    'categories',
    _$categories,
    opt: true,
    def: const [],
...
mixin LiveStateMappable {
  String toJson() {
    return LiveStateMapper.ensureInitialized().encodeJson<LiveState>(
      this as LiveState,
    );
  }

  Map<String, dynamic> toMap() {
    return LiveStateMapper.ensureInitialized().encodeMap<LiveState>(
      this as LiveState,
    );
  }
  ...
  @override
  String toString() {
    return LiveStateMapper.ensureInitialized().stringifyValue(
      this as LiveState,
    );
  }
  ...
  bool operator ==(Object other) {
    return LiveStateMapper.ensureInitialized().equalsValue(
      this as LiveState,
      other,
    );
  }
