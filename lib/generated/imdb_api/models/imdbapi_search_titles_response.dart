...
class ImdbapiSearchTitlesResponse implements AdditionalDataHolder, Parsable {
    ///  Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    @override
    Map<String, Object?> additionalData;
    ///  List of titles matching the search query.
    Iterable<ImdbapiTitle>? titles;
    /// Instantiates a new [ImdbapiSearchTitlesResponse] and sets the default values.
    ImdbapiSearchTitlesResponse() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static ImdbapiSearchTitlesResponse createFromDiscriminatorValue(ParseNode parseNode) {
