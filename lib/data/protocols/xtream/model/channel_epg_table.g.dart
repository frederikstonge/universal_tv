...
XTremeCodeChannelEpgTable _$XTremeCodeChannelEpgTableFromJson(Map<String, dynamic> json) => XTremeCodeChannelEpgTable(
  epgListings:
      (json['epg_listings'] as List<dynamic>?)
          ?.map((e) => XTremeCodeEpgListingTable.fromJson(e as Map<String, dynamic>))
          .toList(),
);

Map<String, dynamic> _$XTremeCodeChannelEpgTableToJson(XTremeCodeChannelEpgTable instance) => <String, dynamic>{
  'epg_listings': instance.epgListings,
};

XTremeCodeEpgListingTable _$XTremeCodeEpgListingTableFromJson(Map<String, dynamic> json) => XTremeCodeEpgListingTable(
...
Map<String, dynamic> _$XTremeCodeEpgListingTableToJson(XTremeCodeEpgListingTable instance) => <String, dynamic>{
  'id': instance.id,
