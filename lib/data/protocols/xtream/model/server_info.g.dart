...
XTremeCodeServerInfo _$XTremeCodeServerInfoFromJson(Map<String, dynamic> json) => XTremeCodeServerInfo(
...
Map<String, dynamic> _$XTremeCodeServerInfoToJson(XTremeCodeServerInfo instance) => <String, dynamic>{
  'xui': instance.xui,
