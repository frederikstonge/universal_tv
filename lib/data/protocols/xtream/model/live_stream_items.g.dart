...
XTremeCodeLiveStreamItem _$XTremeCodeLiveStreamItemFromJson(Map<String, dynamic> json) => XTremeCodeLiveStreamItem(
...
Map<String, dynamic> _$XTremeCodeLiveStreamItemToJson(XTremeCodeLiveStreamItem instance) => <String, dynamic>{
  'num': instance.num,
  'name': instance.name,
