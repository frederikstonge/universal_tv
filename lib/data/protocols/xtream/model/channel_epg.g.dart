...
XTremeCodeChannelEpg _$XTremeCodeChannelEpgFromJson(Map<String, dynamic> json) => XTremeCodeChannelEpg(
  epgListings:
...
Map<String, dynamic> _$XTremeCodeChannelEpgToJson(XTremeCodeChannelEpg instance) => <String, dynamic>{
  'epg_listings': instance.epgListings,
};

XTremeCodeEpgListing _$XTremeCodeEpgListingFromJson(Map<String, dynamic> json) => XTremeCodeEpgListing(
...
Map<String, dynamic> _$XTremeCodeEpgListingToJson(XTremeCodeEpgListing instance) => <String, dynamic>{
  'id': instance.id,
