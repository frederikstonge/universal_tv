...
XTremeCodeSeriesInfo _$XTremeCodeSeriesInfoFromJson(Map<String, dynamic> json) => XTremeCodeSeriesInfo(
  seasons:
      (json['seasons'] as List<dynamic>?)?.map((e) => XTremeCodeSeason.fromJson(e as Map<String, dynamic>)).toList(),
  info: XTremeCodeInfo.fromJson(json['info'] as Map<String, dynamic>),
  episodes: (json['episodes'] as Map<String, dynamic>?)?.map(
    (k, e) =>
        MapEntry(k, (e as List<dynamic>).map((e) => XTremeCodeEpisode.fromJson(e as Map<String, dynamic>)).toList()),
  ),
);

Map<String, dynamic> _$XTremeCodeSeriesInfoToJson(XTremeCodeSeriesInfo instance) => <String, dynamic>{
  'seasons': instance.seasons,
  'info': instance.info,
  'episodes': instance.episodes,
};

XTremeCodeSeason _$XTremeCodeSeasonFromJson(Map<String, dynamic> json) => XTremeCodeSeason(
...
Map<String, dynamic> _$XTremeCodeSeasonToJson(XTremeCodeSeason instance) => <String, dynamic>{
...
XTremeCodeInfo _$XTremeCodeInfoFromJson(Map<String, dynamic> json) => XTremeCodeInfo(
  name: json['name'] as String?,
  ...
  backdropPath: (json['backdrop_path'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
  ...
  categoryIds: (json['category_ids'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ?? const [],
);

Map<String, dynamic> _$XTremeCodeInfoToJson(XTremeCodeInfo instance) => <String, dynamic>{
  'name': instance.name,
...
XTremeCodeEpisode _$XTremeCodeEpisodeFromJson(Map<String, dynamic> json) => XTremeCodeEpisode(
  id: dynamicToIntConverter(json['id']),
  episodeNum: dynamicToIntConverter(json['episode_num']),
  title: json['title'] as String?,
  containerExtension: json['container_extension'] as String?,
  info: XTremeCodeEpisodeInfo.fromJson(json['info'] as Map<String, dynamic>),
  subtitles: (json['subtitles'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
Map<String, dynamic> _$XTremeCodeEpisodeToJson(XTremeCodeEpisode instance) => <String, dynamic>{
  'id': instance.id,
...
XTremeCodeEpisodeInfo _$XTremeCodeEpisodeInfoFromJson(Map<String, dynamic> json) => XTremeCodeEpisodeInfo(
...
Map<String, dynamic> _$XTremeCodeEpisodeInfoToJson(XTremeCodeEpisodeInfo instance) => <String, dynamic>{
