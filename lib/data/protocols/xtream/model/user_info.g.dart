...
XTremeCodeUserInfo _$XTremeCodeUserInfoFromJson(Map<String, dynamic> json) => XTremeCodeUserInfo(
  ...
  allowedOutputFormats: (json['allowed_output_formats'] as List<dynamic>?)?.map((e) => e as String).toList(),
);

Map<String, dynamic> _$XTremeCodeUserInfoToJson(XTremeCodeUserInfo instance) => <String, dynamic>{
