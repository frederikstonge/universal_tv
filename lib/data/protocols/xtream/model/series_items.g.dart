...
XTremeCodeSeriesItem _$XTremeCodeSeriesItemFromJson(Map<String, dynamic> json) => XTremeCodeSeriesItem(
...
Map<String, dynamic> _$XTremeCodeSeriesItemToJson(XTremeCodeSeriesItem instance) => <String, dynamic>{
  'num': instance.num,
  'name': instance.name,
